...
faq = {
    ...
    "— Что запрещено в общежитии?":
        ...
        <p> </p>
        <p>см. <a href="https://unecon.ru/wp-content/uploads/2025/12/2025-12-09-557.pdf" target="_blank">раздел 5 «Обязанности проживающих в студенческом общежитии»</a>.</p>
        "</ul>",
    ...
    "— Как распределяют студентов по общежитиям?":
        "<p>В личном кабинете студента у каждого абитуриента после выхода приказа о зачислении открывается возможность "
    ...
    "— Когда начнется заселение в общежития?":
        "<p><b>С 24 августа</b> начнется заселение. Приезжать необходимо в то общежитие, которое вы забронировали "
